	...
	<tbody style="font-size: 13px;">
		...
		foreach($arrayTOdontograma as $key => $value) 
		{
			...
			<tr>
				...
				<td><input id="<?=$value->getCodigoOdontograma()?>" type="button" class="button2" id="realizado" name="realizado" style="background: green;" value="Realizado" onclick="eliminar(this.id);"></td>
			</tr>
			<?php
		}
		?>
